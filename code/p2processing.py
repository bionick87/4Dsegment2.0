...
def apply_PC(subject, data_dir, param_dir, atlases_list, landmarks_list, mirtk):
    ...
    if os.path.isdir(subject_dir):
        ...
        subject_landmarks = '{0}/landmarks2.vtk'.format(subject_dir)
        ...
        for fr in ['ED', 'ES']:
            ...
            topSimilarAtlases_list, savedInd = topSimilarAtlasShapeSelection(atlases_list[fr], landmarks_list[fr], 
                                               subject_landmarks, tmps_dir, dofs_dir, DLSeg, param_dir, 1) 
    ...
    if parallel:
        ...
        for subject in sorted(os.listdir(data_dir)):
            ...
            for fr in ['ED', 'ES']:
                ...
                topSimilarAtlases_list, savedInd = topSimilarAtlasShapeSelection(atlases_list[fr], landmarks_list[fr], 
                                                   subject_landmarks, tmps_dir, dofs_dir, DLSeg, param_dir, 11) 
